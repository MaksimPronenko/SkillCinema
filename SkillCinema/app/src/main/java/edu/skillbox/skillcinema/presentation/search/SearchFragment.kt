...
import edu.skillbox.skillcinema.presentation.adapters.SearchPagedListAdapter
...
class SearchFragment : Fragment() {
    ...
    private lateinit var filmsAdapter: SearchPagedListAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        filmsAdapter = SearchPagedListAdapter(
